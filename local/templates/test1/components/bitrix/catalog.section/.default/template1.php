...
<? if ($arResult["ITEMS"]): ?>
	<?php 
     ...
     // активные элементы с учетом даты
		);
		$sorting = "catalog_PRICE_1";
				$method = "asc";
		...
		$arNavParams = array(
			'nPageSize' => 9,   // количество элементов на странице
					...
					<div class="sorting__item">
						...
						<select id="sort-item" class=" selectoption selectpicker show-tick sorting__list js-sorting-list">
							<option <?php if ($sort == 'price_asc')
								...
								<span>Цене <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up-short" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M8 12a.5.5 0 0 0 .5-.5V5.707l2.146 2.147a.5.5 0 0 0 .708-.708l-3-3a.5.5 0 0 0-.708 0l-3 3a.5.5 0 1 0 .708.708L7.5 5.707V11.5a.5.5 0 0 0 .5.5z"/>
</svg></span>
							</option>
							<option <?php if ($sort == 'price_desc')
										echo "selected class='is-active'" ?> value="?sorting=price_desc">
								<span>Цене <i class="bi bi-arrow-down-short"></i> </span>
							</option>
					...
					<div class="catalog__content">
						<ul class="catalog__products js-container">
							...
							while($ob = $dbResult->GetNextElement()){ 
								...
								$this->AddDeleteAction($arFields['ID'], $arFields['DELETE_LINK'], CIBlock::GetArrayByID($arFields["IBLOCK_ID"], "ELEMENT_DELETE"), array("CONFIRM" => GetMessage('CT_BCS_ELEMENT_DELETE_CONFIRM')));
								$img_path = CFile::GetPath($arFields["PREVIEW_PICTURE"]);

								?>

								<li id="<?= $this->GetEditAreaId($arFields['ID']); ?>" class=" catalog__item">
									...
									<a class="catalog__item-img" href="<?= $arFields["DETAIL_PAGE_URL"] ?>">
									...
									<div class="catalog__item-content">
										...
										<a class="catalog__item-title" href="<?= $arFields["DETAIL_PAGE_URL"] ?>"><span>
												<?= $arFields["NAME"] ?>
											</span></a>
